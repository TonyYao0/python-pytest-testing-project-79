...
@pytest.mark.parametrize("url, expected_name", [
    ...
    (
        "https://ru.hexlet.io.assets.professions.menu.css", 
        "ru-hexlet-io-assets-professions-menu.css"),
    (
        "https://ru.hexlet.io.assets.professions.runtime.png", 
        "ru-hexlet-io-assets-professions-runtime.png"),
